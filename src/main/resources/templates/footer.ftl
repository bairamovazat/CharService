<!--Footer-->
      <footer class="page-footer font-small stylish-color-dark bg-light pt-4 mt-4">
          ...
          <div class="container text-center text-md-left">
              ...
              <div class="row py-3 d-flex align-items-center">
                  ...
                  <div class="col-md-8 col-lg-8">
                      ...
                      <!--Copyright Copied from opMDBootstrap.com-->
                      <p class="text-center text-md-left grey-text">© 2018 Copyright: <a href="#"><strong>Copyright</strong></a></p>
                      <!--/.Copyright-->
